function train {
	...
	MODEL_NAME="0509_relu_softmax_henryk/${DIFFICULTY}_l${LEVEL_NUMBER}_sa${ATTENTION}_ra${RELU_ATTENTION}_ss${SOFTMAX_SEBASTIAN}_sc${SOFTMAX_CHRISTIAN}_t${TEMPERATURE//./}_t${TPU_NAME}"
